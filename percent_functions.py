...
hb_vs_mj= headbend_vs_majority ('sub-1_task-Sleep_acq-headband_events.tsv','sub-1_task-Sleep_acq-psg_events.tsv')
ai_vs_mj= aispg_vs_majority ('sub-1_task-Sleep_acq-psg_events.tsv')

print (f"headbend vs majority:{hb_vs_mj} \t ai psg vs majority:{ai_vs_mj}")